<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveStudent.aspx.cs" Inherits="gradingsystem.RemoveStudent" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <asp:GridView ID="gv_removestudent" runat="server" AutoGenerateColumns="False" Width="600px"
...
<AlternatingRowStyle CssClass="alt" BackColor="White"></AlternatingRowStyle>
                        <Columns>
                            <asp:TemplateField HeaderText="Select">
                                <ItemTemplate>
                                    <asp:CheckBox ID="remove_student" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="student_course_id" HeaderText="Student Course ID"/>
...
<PagerStyle CssClass="pgr" BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center"></PagerStyle>
                    ...
                    <asp:Button ID="btndeletestudent" class="btn btn-danger" runat="server" Text="Delete" OnClick="Button_deletestudent" />
